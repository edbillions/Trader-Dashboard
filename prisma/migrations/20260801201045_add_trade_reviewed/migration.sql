...
INSERT INTO "new_Trade" ("accountId", "commission", "createdAt", "dailyBias", "direction", "entryChartLink", "entryModel", "entryPrice", "entryTime", "entryTimeframe", "exitPrice", "exitTime", "grossPnl", "htfChartLink", "htfDol", "htfPoi", "id", "intermediateChartLink", "maeR", "mfeR", "netPnl", "positionSize", "rMultiple", "session", "setupFactorsChecklist", "setupGrade", "smartReview", "stopLossActual", "stopLossPlanned", "symbol", "targetActual", "targetPlanned", "tradingDayId", "updatedAt", "writeup") SELECT "accountId", "commission", "createdAt", "dailyBias", "direction", "entryChartLink", "entryModel", "entryPrice", "entryTime", "entryTimeframe", "exitPrice", "exitTime", "grossPnl", "htfChartLink", "htfDol", "htfPoi", "id", "intermediateChartLink", "maeR", "mfeR", "netPnl", "positionSize", "rMultiple", "session", "setupFactorsChecklist", "setupGrade", "smartReview", "stopLossActual", "stopLossPlanned", "symbol", "targetActual", "targetPlanned", "tradingDayId", "updatedAt", "writeup" FROM "Trade";
DROP TABLE "Trade";
